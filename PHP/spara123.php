...
$stmt = $dbh->prepare("INSERT INTO din_tabell (fnamn, enamn, telnr, mail, styrka_höger_arm, styrka_vänster_arm, styrka_höger_ben, styrka_vänster_ben, styrka_höger_hand, styrka_vänster_hand, kryckor, rullator, rullstol, manuell_rullstol_hjälpmotor, elmoped, permobil, annat_hjälpmedel, kryckor_till_fordon, rullator_till_fordon, rullstol_till_fordon, hjälpmotor_till_fordon, elmoped_till_fordon, permobil_till_fordon, forare_passagerare, anpassad_bil, mindre_personbil, storre_personbil, suv, mindre_transportbil, amerikansk_golvsanktbil, minibuss, annat_fordon, vet_ej) 
                      VALUES (:fnamn, :enamn, :telnr, :mail, :right_arm, :left_arm, :right_leg, :left_leg, :right_hand, :left_hand, :kryckor, :rullator, :rullstol, :manuell_rullstol_hjälpmotor, :elmoped, :permobil, :annat_hjälpmedel, :kryckor_till_fordon, :rullator_till_fordon, :rullstol_till_fordon, :hjälpmotor_till_fordon, :elmoped_till_fordon, :permobil_till_fordon, :forare_passagerare, :anpassad_bil, :mindre_personbil, :storre_personbil, :suv, :mindre_transportbil, :amerikansk_golvsanktbil, :minibuss, :annat_fordon, :vet_ej)
                      ON CONFLICT(id) DO UPDATE SET fnamn = :fnamn, enamn = :enamn, telnr = :telnr, mail = :mail, styrka_höger_arm = :right_arm, styrka_vänster_arm = :left_arm, styrka_höger_ben = :right_leg, styrka_vänster_ben = :left_leg, styrka_höger_hand = :right_hand, styrka_vänster_hand = :left_hand, kryckor = :kryckor, rullator = :rullator, rullstol = :rullstol, manuell_rullstol_hjälpmotor = :manuell_rullstol_hjälpmotor, elmoped = :elmoped, permobil = :permobil, annat_hjälpmedel = :annat_hjälpmedel, kryckor_till_fordon = :kryckor_till_fordon, rullator_till_fordon = :rullator_till_fordon, rullstol_till_fordon = :rullstol_till_fordon, hjälpmotor_till_fordon = :hjälpmotor_till_fordon, elmoped_till_fordon = :elmoped_till_fordon, permobil_till_fordon = :permobil_till_fordon, forare_passagerare = :forare_passagerare, anpassad_bil = :anpassad_bil, mindre_personbil = :mindre_personbil, storre_personbil = :storre_personbil, suv = :suv, mindre_transportbil = :mindre_transportbil, amerikansk_golvsanktbil = :amerikansk_golvsanktbil, minibuss = :minibuss, annat_fordon = :annat_fordon, vet_ej = :vet_ej");
